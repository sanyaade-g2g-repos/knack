...
{
	/// <summary>
	/// Description of TabletNotFoundException.
	/// </summary>
	public class TabletNotFoundException : TabletException
	{
		public TabletNotFoundException()
		{ }
		
		public TabletNotFoundException(string msg) : base(msg)
		{ }
	}
}
