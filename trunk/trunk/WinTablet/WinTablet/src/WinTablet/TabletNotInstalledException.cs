...
{
	/// <summary>
	/// Description of TabletNotInstalledException.
	/// </summary>
	public class TabletNotInstalledException : TabletException
	{
		public TabletNotInstalledException()
		{ }
		
		public TabletNotInstalledException(string msg) : base(msg)
		{ }
	}
}
