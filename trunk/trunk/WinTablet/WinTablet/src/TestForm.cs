...
{
	/// <summary>
	/// A TabletForm test : a simple painting application.
	/// </summary>
	public class TestForm : TabletForm
	{
		...
		public TestForm()
		{
			...
			this.TabletPacket += new TabletPacketEventHandler(TabletPacketHandler);
		}
		...
		private void InitializeComponent() {
			...
			this.textBoxLog.Size = new System.Drawing.Size(454, 51);
			...
			this.Text = "WinTablet Test by h3-r3";
