...
{
	public class SubtractOperatorSoundRender : OperatorSoundRender
	{
		public SubtractOperatorSoundRender() : base()
		{ }
		
		public SubtractOperatorSoundRender(ISoundRender soundRenderA,ISoundRender soundRenderB) : base(soundRenderA,soundRenderB)
		{ }
		...
		protected override System.Drawing.Image LoadIcon() {
			...
			return (System.Drawing.Image) resources.GetObject("op-subtract");
		}
