...
{
	public class MultiplyOperatorSoundRender : OperatorSoundRender
	{
		public MultiplyOperatorSoundRender() : base()
		{ }
		
		public MultiplyOperatorSoundRender(ISoundRender soundRenderA,ISoundRender soundRenderB) : base(soundRenderA,soundRenderB)
		{ }
		...
		protected override System.Drawing.Image LoadIcon() {
			...
			return (System.Drawing.Image) resources.GetObject("op-multiply");
		}
